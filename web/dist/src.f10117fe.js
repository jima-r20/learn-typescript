...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attibutes":"src/models/Attibutes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
if (root) {
  ...
  throw new Error('Root element no found');
}
