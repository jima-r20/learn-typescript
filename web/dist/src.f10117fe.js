...
exports.Sync = Sync;
},{"axios":"node_modules/axios/index.js"}],"src/models/Attibutes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function User(attrs) {
    ...
    this.attributes = new Attibutes_1.Attributes(attrs);
  }
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts","./Attibutes":"src/models/Attibutes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
