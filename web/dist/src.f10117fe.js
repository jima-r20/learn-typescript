...
exports.Model = Model;
},{}],"src/models/Attibutes.ts":[function(require,module,exports) {
"use strict";
...
var Attibutes_1 = require("./Attibutes");
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attibutes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };

  User.buildUderCollection = function () {
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attibutes":"src/models/Attibutes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var collection = User_1.User.buildUderCollection();
